...
var HTMLquantidade = '<input type="number" class="form-control input-sm qtd">';
var HTMLicone = '<button type="button" action="" id="remove" class="btn btn-link btn-xs remove"><span class="glyphicon glyphicon-trash"> </span></button>';
